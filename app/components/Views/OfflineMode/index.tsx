...
interface OfflineModeOwnProps {
  navigation: any;
}

type OfflineModeProps = PropsFromRedux & OfflineModeOwnProps;
...
OfflineMode.navigationOptions = ({ navigation }: any) =>
  getOfflineModalNavbar(navigation);

export default connector(OfflineMode);
