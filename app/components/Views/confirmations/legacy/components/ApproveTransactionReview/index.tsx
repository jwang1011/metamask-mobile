...
interface ApproveTransactionReviewProps {
  ...
  QRState?: any;
  gasSelected?: string;
  updateTransactionState?: (state: any) => void;
  legacyGasObject?: any;
...
class ApproveTransactionReview extends PureComponent<ApproveTransactionReviewProps, ApproveTransactionReviewState> {
  ...
  componentDidUpdate = (_: ApproveTransactionReviewProps, prevState: ApproveTransactionReviewState) => {
  ...
  getTrustMessage = (originIsDeeplink: boolean, isMethodSetApprovalForAll: boolean) => {
